  ...
  return (
    <div className="flex h-full w-full  md:py-2 dark:bg-[#141414]">
      ...
      <div className="w-full flex-1">
        <div className="bg-panelLight dark:bg-panelDark h-[calc(100dvh-)] border flex-1 flex-col overflow-y-auto overflow-x-hidden border-[#E7E7E7] shadow-inner md:flex md:mr-1 max-w-full md:rounded-2xl md:shadow-sm dark:border-[#252525] ">
