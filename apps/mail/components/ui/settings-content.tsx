...
export function SettingsLayoutContent({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex h-full w-full border md:py-2">
      <AppSidebar className="hidden lg:flex" />
      <div className="w-full flex-1">
        <div className="bg-panelLight dark:bg-panelDark h-[calc(100dvh-)]  flex-1 flex-col overflow-y-auto overflow-x-hidden border-[#E7E7E7] shadow-inner md:flex mr-1 max-w-[1400px] md:rounded-2xl md:border md:shadow-sm dark:border-[#252525]">
